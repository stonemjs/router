...
describe('RouteCollection', () => {
  ...
  describe('#match', () => {
    ...
    it('Check the matching and return a matched route', async () => {
      // Arrange
      const routes = new RouteCollection()
      const request = { method: GET, decodedPathname: '/users/12', isSecure: false, getUri () { return this.decodedPathname } }
    ...
    it('Check the matching and throw exception when match found with different method', () => {
      // Arrange
      const routes = new RouteCollection()
      const request = { method: POST, decodedPathname: '/users', isSecure: false, getUri () { return this.decodedPathname } }
    ...
    it('Check the matching and throw exception when no matches found', () => {
      // Arrange
      const routes = new RouteCollection()
      const request = { method: GET, decodedPathname: '/users/doe', isSecure: false, getUri () { return this.decodedPathname } }
